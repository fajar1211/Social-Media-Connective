...
POLLINATIONS_DEFAULT_WIDTH = int(os.getenv("POLLINATIONS_DEFAULT_WIDTH", "1024"))
POLLINATIONS_DEFAULT_HEIGHT = int(os.getenv("POLLINATIONS_DEFAULT_HEIGHT", "1024"))
IMAGE_REQUEST_DELAY = int(os.getenv("IMAGE_REQUEST_DELAY", "2"))
