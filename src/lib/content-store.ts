...
export type SocialPlatform = "Facebook" | "Instagram" | "YouTube" | "Google Business Profile" | "LinkedIn";

export const PLATFORMS: Platform[] = ["Facebook", "Instagram", "X / Twitter", "LinkedIn", "Blog"];
export const SOCIAL_PLATFORMS: SocialPlatform[] = ["Facebook", "Instagram", "YouTube", "Google Business Profile", "LinkedIn"];
